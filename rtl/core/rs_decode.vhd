...
begin
	...
	-- USES_RS1: instructionst hat use RS1 get a '1' otherwise '0'
	USES_RS1	<=	'1' when (OPCODE = OP_RTYPE
							 or OPCODE = OP_IARITH
							 or OPCODE = OP_LOAD
							 or OPCODE = OP_STORE
							 or OPCODE = OP_BRANCH
	...
	-- USES_RS2: instructions that use rs2 get '1' otherwise '0'
	USES_RS2	<=	'1' when (OPCODE = OP_RTYPE
							 or OPCODE = OP_STORE
